...
parser$add_argument("--label_f1_results", help = "Path to the label_f1_results file", default="/space/grp/rschwartz/rschwartz/evaluation_summary.nf/SCT_integrated_mmus/aggregated_results/label_f1_results.tsv")
...
factor_names <- c("label","reference", "method", "cutoff")
...
if (organism == "homo_sapiens") {
  ...
  formulas <- list(
    ...
    paste("f1_score ~", paste(c(factor_names, "method:cutoff","disease_state"),collapse = "+")),
    paste("f1_score ~", paste(c(factor_names, "method:cutoff","sex"),collapse = "+")),
    paste("f1_score ~", paste(c(factor_names, "method:cutoff","region_match"),collapse = "+")),
    paste("f1_score ~", paste(c(factor_names, "method:cutoff", "reference:method"), collapse = " + ")),
    paste("f1_score ~", paste(c(all_factors, "method:cutoff", "reference:method"), collapse = " + "))
    )
  ...
  formulas <- list(
    paste("f1_score ~", paste(c(factor_names, "method:cutoff"), collapse = " + ")),
    paste("f1_score ~", paste(c(factor_names, "method:cutoff","treatment"),collapse = " + ")),
    paste("f1_score ~", paste(c(factor_names, "method:cutoff","sex"),collapse = " + ")),
    paste("f1_score ~", paste(c(factor_names, "method:cutoff", "reference:method"), collapse = " + ")),
    paste("f1_score ~", paste(c(all_factors, "method:cutoff", "reference:method"), collapse = " + "))
