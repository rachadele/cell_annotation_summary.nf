        ...
        if not level_df.empty:
          ...
          #  metric_label = metric.replace('_', ' ').capitalize()
           # group_col_label = group_col.replace('_', ' ').capitalize()
            ...
            plt.suptitle(ORGANISM_TITLE, fontsize=MEDIUM_SIZE)
            plt.tight_layout()
...
def main():
    ...
    global ORGANISM_TITLE
    ORGANISM_TITLE = {"mus_musculus": "Mouse", "homo_sapiens": "Human"}.get(args.organism, args.organism)
