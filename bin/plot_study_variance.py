#!/usr/bin/env python3
"""
Cell-type F1 score heatmap across studies (mouse).
...
Usage:
    python plot_study_variance.py \\
        --mm_labels 2024-07-01/mus_musculus/.../label_results.tsv \\
        --outdir figures
"""
...
def parse_args():
    ...
    p.add_argument("--mm_labels", default=DEFAULT_MM)
...
def main():
    ...
    print("Loading data...")
    pivot = load_pivot(args.mm_labels, args.key, args.cutoff)
    ...
    ax.set_title(
        f"Cell type F1 by study — mouse ({args.key}, cutoff={args.cutoff})",
